 ...
 * about for a home electricity bill), excluding VAT - consistent with Ecowatt/EDF Tempo.
 * @param {number} eurPerMwh - Price in EUR/MWh.
 * @returns {number} Price in cents/kWh, excluding VAT, rounded to 2 decimals.
 * @example
