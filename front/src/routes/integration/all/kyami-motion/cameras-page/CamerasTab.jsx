...
const CamerasTab = props => (
  <SecurityCameraPage>
    ...
    <div class="card">
      ...
      <div class="card-body">
        {props.kyamiGetSourcesStatus === RequestStatus.Getting && (
          <p class="text-muted">
          ...
          {props.kyamiSources &&
            props.kyamiSources.map((camera, index) => (
              <div class="col-md-4 mb-4" key={camera.source}>
                <div class="card">
                  {camera.snapshot && <img class="card-img-top" src={`data:${camera.snapshot}`} alt={camera.source} />}
                  <div class="card-body">
